...
<div id="line">
	...
	<tr style="font-weight:bold;">
		...
		<td>操作</td>
	<tr>
	<?php foreach ($agentList as $item) { ?>
	<tr>
		<td><?php echo ($item["name"]); ?></td>
		<td><?php echo ($item["type_id"]); ?></td>
		<td><?php echo ($item["code"]); ?></td>
		<td><?php echo ($item["school"]); ?></td>
		<td><?php echo ($item["earned_money"]); ?></td>
		<td><?php echo ($item["father_money"]); ?></td>
		<td><?php echo ($item["history_money"]); ?></td>
		<td><?php echo ($item["time"]); ?></td>
		<td><a href="<?php echo U('Admin/cAgent?id='.$item['user_id']) ?>">修改</a></td>
	<tr>
	<?php } ?>
	</table>
	<div class="clear"></div>
